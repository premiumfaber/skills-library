...
description: "Design event-sourced systems, event streams, command handling, event application, schema evolution, snapshots, replay, projections, and eventual consistency. Use when the event log should be the source of truth, audit history matters, or temporal queries are required."
---
