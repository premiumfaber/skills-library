...
> Status update, 2026-05-10: this original file-based skill marketplace design has been superseded by the Codex plugin marketplace structure in `.agents/plugins/marketplace.json` and `plugins/sdlc/`. It remains as historical design context.
